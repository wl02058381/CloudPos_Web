...
class HistoryOrder extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            "selectedDate": moment(),
            "PeriodType": "day",
            "KeyboardDatePicker_view_HistoryOrder": ["year", "month", "date"],
            "KeyboardDatePicker_format_HistoryOrder": "yyyy-MM-dd",
        };
    ...
    GetOrderData() {
        ...
        fetch(this.state.API_UrL + "/OrderHistory", requestOptions)
            .then(response => response.text())
            .then((result) => {
                // console.log(result)
    ...
    handleDatePeriod() {
        var Period = $("[name=Period_HistoryOrder]").val()
        console.log(`${Period}`)
    ...
    KeyboardDatePickerType() {
        ...
        var KeyboardDatePicker_view_HistoryOrder;
        var KeyboardDatePicker_format_HistoryOrder;
        if (PeriodType == "year") {
            KeyboardDatePicker_view_HistoryOrder = ["year"]
            KeyboardDatePicker_format_HistoryOrder = "yyyy"
        } else if (PeriodType == "month") {
            KeyboardDatePicker_view_HistoryOrder = ["year", "month"]
            KeyboardDatePicker_format_HistoryOrder = "yyyy-MM"
        ...
        this.setState({
            "KeyboardDatePicker_view_HistoryOrder": KeyboardDatePicker_view_HistoryOrder,
            "KeyboardDatePicker_format_HistoryOrder": KeyboardDatePicker_format_HistoryOrder,
        })
                        ...
                        <MuiPickersUtilsProvider utils={DateFnsUtils}>
                            <Col>
                                <Form.Group controlId="exampleForm.ControlSelect1" >
                                    ...
                                    <Form.Control as="select" name="Period_HistoryOrder" defaultValue={this.state.PeriodType} onChange={this.handleDatePeriod}>
                            ...
                            <Col>
                                <KeyboardDatePicker
                                    views={this.state.KeyboardDatePicker_view_HistoryOrder}
                                    margin="normal"
                                    id="date-picker-dialog"
                                    label="Date picker dialog"
                                    format={this.state.KeyboardDatePicker_format_HistoryOrder}
