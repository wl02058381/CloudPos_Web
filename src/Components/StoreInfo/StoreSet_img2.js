...
class StorePage extends Component {
    ...
    componentDidMount() {
        ...
        if (StoreID != null){
            ...
            var getStoreID = sessionStorage.getItem('StoreID');
            this.setState({ StoreID: getStoreID });
        }
    }
                    ...
                    <Row><Col>
                        <Carousel>
                            <Carousel.Item interval={1000}>
                                < div id="bkcolor" > < img className="Header_Img_style" src={`${Config.ImgURL}${getStoreID}/Store_1`}
                                /></div >

                            </Carousel.Item>
                            <Carousel.Item interval={500}>
                                <div id="bkcolor" ><img className="Header_Img_style" src={`${Config.ImgURL}${getStoreID}/Store_2`} /></div>

                            </Carousel.Item>
                            <Carousel.Item>
                                <div id="bkcolor" ><img className="Header_Img_style" src={`${Config.ImgURL}${getStoreID}/Store_3`} /></div>
