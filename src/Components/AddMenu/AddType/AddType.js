...
class AddType extends Component {
    ...
    GetFoodTypeName() {
        ...
        for (var FoodType_key in FoodType) {
            ...
            //             {/* <input type="checkbox" value="冰度" /> */}
            //             <Form.Check type="checkbox" id={`check-api-`}><Form.Check.Input id="ChooseBtnStyle" type="checkbox" isValid /><Form.Check.Label id="ChooseTxtStyle"></Form.Check.Label></Form.Check>
            //                         {FoodType[FoodType_key]["FoodTypeName"]}
            //                 </Accordion.Toggle>
            //     </Card.Header>
            // </Card>)
